    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>Tu reporte con consecutivo <strong>{{ $info['consecutivo'] }}</strong> Paso a estado en proceso, por lo que te estaremos notificando cuando tu reporte pase a estado RESUELTO</p>
                <hr />
